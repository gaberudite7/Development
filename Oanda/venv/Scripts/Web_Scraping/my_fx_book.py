...
def get_perc_from_style(style):
    return re.search(r'(\d+)', style).group()#extract any group with 1 or more digits
...
def run_sentiment_scrape():
    ...
    #soup = get_soup_from_file(r"my_fx_book_sentiment")

    soup = get_soup_from_url(r"https://www.myfxbook.com/community/outlook")
