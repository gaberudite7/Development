...
def run_bot():
    ...
    trade_worker_t.daemon = True # This will make the thread stop when the main program exits
    ...
    for p in TradeSettingsCollection.pair_list():
        candle_t = CandleWorker(TradeSettingsCollection.get_trade_settings(p),
                                    candle_queue,
                                    trade_work_queue,
