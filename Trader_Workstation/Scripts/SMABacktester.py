...
class SMABacktester():
    ...
    def get_data(self):
        ...
        '''
        raw = pd.read_csv(r"C:\Development\Trader_Workstation\Udemy\Part3\forex_pairs.csv", parse_dates = ["Date"], index_col = "Date")
...
if __name__ == "__main__":
    ...
    # Find optimal sma short/ sma long parameters (1 is step size)
    # will return parameters for sma short within 10-50 days and sma long within 100 and 252 days as well as performance
