...
def onBarUpdate(bars, hasNewBar):  
    global df, last_bar
    # check if current (incomeplete) bar is more recent than last complete bar
...
if __name__ == "__main__": # if you run trader.py as python script
    ...
    # Keep up to date = true means we are pulling historical data as well as updated data
