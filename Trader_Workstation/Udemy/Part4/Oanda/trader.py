...
import numpy as np
import tpqoa
from datetime import datetime, timezone, timedelta # timezone added (Python 3.12)
import time
import warnings
...
if __name__ == "__main__":
    ...
    trader = ConTrader(r"INSERT YOUR FULL FILEPATH HERE", "EUR_USD", "1min", window = 1, units = 100000)
